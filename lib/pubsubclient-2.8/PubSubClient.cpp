...
boolean PubSubClient::publish_Q1(const char* topic, const char* payload) {
    return publish_Q1(topic,(const uint8_t*)payload, payload ? strnlen(payload, this->bufferSize) : 0);
}
