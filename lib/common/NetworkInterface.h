#ifndef SENSENET_NETWORK_INTERFACE_TPP
#define SENSENET_NETWORK_INTERFACE_TPP

typedef std::function<bool(void)> NetworkCommandInterface;

typedef std::function<void(void)> ConnectionEvent;

typedef std::function<Client *(void)> CreateClientInterface;
